...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <nav class="header-nav ms-auto">
            ...
            @else
                <!-- Handle case when no user is authenticated, for example, display a login link -->
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" href="{{ Route('admin.payments.index') }}">
                    <i class="bi bi-box-arrow-in-right"></i>
                    <span>Payment_Product</span>
                </a>
            </li> --}}
            {{-- <li class="nav-item">
                <a class="nav-link collapsed" id="toggleTable" href="{{  route('admin.sold-products') }}" onclick="moveToSidebar()" data-bs-toggle="collapse"
                    data-bs-target="#table-nav">
                    <i class="bi bi-box-arrow-in-right"></i>
                    <span>Sold_Products</span>
                </a>
            </li> --}}
